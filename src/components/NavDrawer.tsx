            ...
            >
                ...
                {LINKS.map((link) => (
                  <motion.li key={link.href} variants={itemVariants}>
                    <a
                      href={link.href}
                      onClick={() => setOpen(false)}
                      className="text-ink text-body block border-l-2 border-transparent px-6 py-4 transition-colors duration-200 ease-out hover:border-guard-olive"
                    >
                      {link.label}
                    </a>
                  </motion.li>
              ...
              <div className="px-6 py-6">
                <a
                  href="/contact"
                  onClick={() => setOpen(false)}
                  className="bg-guard-olive text-ink hover:bg-guard-green-deep hover:text-paper inline-flex w-full items-center justify-center rounded-none px-6 py-3 text-caption transition-colors duration-200 ease-out"
                >
                  Get a Quote
                </a>
              </div>
